...
if (!file.exists("RData/JAGS_out_rSlope_rInt_logD_FL.rds")){
  ...
  jm.FL.1Cov1_1 <- readRDS("RData/JAGS_out_rSlope_rInt_logD_FL.rds")
}
...
if (!file.exists("RData/JAGS_out_rSlope_rInt_DayWk_FL.rds")){
  ...
  jm.FL.1Cov1_2 <- readRDS("RData/JAGS_out_rSlope_rInt_DayWk_FL.rds")
}
...
if (!file.exists("RData/JAGS_out_rSlope_rInt_DayYr_FL.rds")){
  ...
  jm.FL.1Cov1_3 <- readRDS("RData/JAGS_out_rSlope_rInt_DayYr_FL.rds")
}
