...
X.FL <- c(cbind(log(FL.nest.counts$distance) - median(log(FL.nest.counts$distance)),
...
WHY DO WE WANT TO CENTER YEAR? IF WE HAVE RANDOM SLOPE AND INTERCEPT, WOULDN'T IT MAKE MORE SENSE TO HAVE MINIMUM YEAR SUBTRACTED SO THAT THE FIRST YEAR IS ZERO, WHICH WILL BE THE INTERCEPT, NO? LOOK INTO THAT - CHECK THE MODEL AGAIN TO SEE WHAT MAKES MORE SENSE. 
