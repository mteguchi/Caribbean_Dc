...
These parameters don't look good and some Rhat stats are > 1.1.  
...
for (p in 1:length(NA.idx)){
  ...
  ggsave(p.1, filename = paste0("figures/beach_", p, "_2Us.png"),
         device = "png", dpi = 600)
}
