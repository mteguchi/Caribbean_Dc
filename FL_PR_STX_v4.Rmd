...
MCMC.params$model.file = "models/Model_norm_Pois_Qs_2Us.txt"

if (!file.exists("RData/JAGS_out_norm_Pois_Qs_2Us.rds")){
  ...
  saveRDS(jm, file = "RData/JAGS_out_norm_Pois_Qs_2Us.rds")
  
} else {
  jm <- readRDS("RData/JAGS_out_norm_Pois_Qs_2Us.rds")
}
