...
In this version (v.6), another parameter (probability of nesting) was added to accomodate the fact that not all females nest every year. No latitude covariate is included.
